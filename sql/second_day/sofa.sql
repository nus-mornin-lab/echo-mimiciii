...
--  1) uosecond - generated by urine-output-first-day.sql
--  2) vitalssecond - generated by vitals-first-day.sql
--  3) gcssecond - generated by gcs-first-day.sql
--  4) labssecond - generated by labs-first-day.sql
--  5) bloodgassecondarterial - generated by blood-gas-first-day-arterial.sql
...
DROP MATERIALIZED VIEW IF EXISTS sofasecond CASCADE;
CREATE MATERIALIZED VIEW sofasecond AS
with wt AS
(
  ...
  AND valuenum != 0
  and charttime between ie.intime + interval '1' day and ie.intime + interval '2' day
...
(
  ...
  inner join inputevents_cv cv
    on ie.icustay_id = cv.icustay_id and cv.charttime between ie.intime + interval '1' day and ie.intime + interval '2' day
  left join wt
...
(
  ...
  inner join inputevents_mv mv
    on ie.icustay_id = mv.icustay_id and mv.starttime between ie.intime + interval '1' day and ie.intime + interval '2' day
...
(
  ...
  from bloodgassecondarterial bg
...
left join vitalssecond v
  on ie.icustay_id = v.icustay_id
left join labssecond l
  on ie.icustay_id = l.icustay_id
left join uosecond uo
  on ie.icustay_id = uo.icustay_id
left join gcssecond gcs
