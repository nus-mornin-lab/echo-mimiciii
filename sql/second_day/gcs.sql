...
DROP MATERIALIZED VIEW IF EXISTS gcssecond CASCADE;
create materialized view gcssecond as
with base as
(
  ...
  and l.charttime between b.intime + interval '1' day and b.intime + interval '2' day
