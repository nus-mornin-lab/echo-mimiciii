...
DROP MATERIALIZED VIEW IF EXISTS uosecond CASCADE;
create materialized view uosecond as
select
  -- patient identifiers
...
and oe.charttime between ie.intime + interval '1' day and (ie.intime + interval '2' day) -- first ICU day
where itemid in
(
