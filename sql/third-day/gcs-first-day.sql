...
DROP MATERIALIZED VIEW IF EXISTS gcsthird CASCADE;
create materialized view gcsthird as
with base as
(
  ...
  and l.charttime between b.intime + interval '2' day and b.intime + interval '3' day
