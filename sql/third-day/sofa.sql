...
--  1) uothird - generated by urine-output-first-day.sql
--  2) vitalsthird - generated by vitals-first-day.sql
--  3) gcsthird - generated by gcs-first-day.sql
--  4) labsthird - generated by labs-first-day.sql
--  5) bloodgasthirdarterial - generated by blood-gas-first-day-arterial.sql
...
DROP MATERIALIZED VIEW IF EXISTS sofathird CASCADE;
CREATE MATERIALIZED VIEW sofathird AS
with wt AS
(
  ...
  AND valuenum != 0
  and charttime between ie.intime + interval '2' day and ie.intime + interval '3' day
...
(
  ...
  inner join inputevents_cv cv
    on ie.icustay_id = cv.icustay_id and cv.charttime between ie.intime + interval '2' day and ie.intime + interval '3' day
  left join wt
...
(
  ...
  inner join inputevents_mv mv
    on ie.icustay_id = mv.icustay_id and mv.starttime between ie.intime + interval '2' day and ie.intime + interval '3' day
...
left join vitalsthird v
  on ie.icustay_id = v.icustay_id
left join labsthird l
  on ie.icustay_id = l.icustay_id
left join uothird uo
  on ie.icustay_id = uo.icustay_id
left join gcsthird gcs
