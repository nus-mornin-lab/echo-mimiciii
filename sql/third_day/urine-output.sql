...
DROP MATERIALIZED VIEW IF EXISTS uothird CASCADE;
create materialized view uothird as
select
  -- patient identifiers
...
and oe.charttime between ie.intime + interval '2' day and (ie.intime + interval '3' day) -- first ICU day
where itemid in
(
