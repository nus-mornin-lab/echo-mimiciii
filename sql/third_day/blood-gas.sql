...
DROP MATERIALIZED VIEW IF EXISTS bloodgasthird CASCADE;
create materialized view bloodgasthird as
with pvt as
( -- begin query that extracts the data
  ...
  -- this also fuses together multiple ITEMIDs containing the same data
    ...
    left join labevents le
      ...
      and le.charttime between (ie.intime + interval '2' day) and (ie.intime + interval '3' day)
      and le.ITEMID in
      -- blood gases
      (
